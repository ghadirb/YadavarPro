...
از نسخهٔ ۵ اسکریپت، مسیر `aiSmartAlert` در یک درخواست هم جملهٔ محاوره‌ای می‌سازد
و هم صوت TTS را برمی‌گرداند. اپ ۱.۴.۴ اگر این مسیر را نبیند، جداگانه چت + TTS
می‌زند. برای هشدار هوشمند گفتاری **حتماً نسخهٔ ۵ را Deploy کنید**:
